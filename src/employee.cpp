  ...
  for (int i = 0; i < size; i++) {
    ...
    do {
      ...
      if (tuoi[i] < 17 || tuoi[i] > 41) {
        cout << "So tuoi vuot qua quy dinh de lam viec[ >=18 va  <=40 ]"
             << endl;
      }
...
bool nhanvien::checkchu(string a) {
...
void system_management_employee::input() {
  do {
    system("cls");
    cout << "=============== MENU ===============";
